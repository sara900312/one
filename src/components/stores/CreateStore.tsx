  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response?.success) {
        ...
        toast.error(response?.error || 'فشل في إنشاء المتجر')
      }
    } catch (error) {
      console.error('Create Store Error:', error)
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-ar">اسم المتجر *</Label>
              <ArabicInput
                id="name"
                value={formData.name}
            ...
            <div className="space-y-2">
              <Label htmlFor="username" className="text-ar">اسم المستخدم *</Label>
              <ArabicInput
                id="username"
            ...
            <div className="space-y-2">
              <Label htmlFor="owner_email" className="text-ar">البريد الإلكتروني</Label>
              <ArabicInput
                id="owner_email"
                type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-ar">رقم الهاتف</Label>
              <ArabicInput
                id="phone"
                type="tel"
            ...
            <div className="space-y-2">
              <Label htmlFor="address" className="text-ar">العنوان</Label>
              <ArabicInput
                id="address"
